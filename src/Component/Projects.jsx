// ✅ Enhanced Mobile Fix for Showcase Reveal
// ✅ Ensures GSAP animations trigger on mobile without ScrollTrigger
...
function Projects() {
  ...
  }, [isMobile, triggerShowcaseAnimations]);
  ...
  return (
    <div id='work' className='bg-[#1e110a] hidden lg:block w-full overflow-hidden' ref={projectsContainerRef}>
            ...
            <div id='opening-center' className="relative w-full min-h-screen bg-[#1e110a] overflow-visible">
              ...
              <div className="showcase-container relative z-10 pt-[60rem] w-full min-h-[600vh] overflow-visible">
                <div ref={showcaseRef} className="showcase-wrapper relative h-full w-full">
                  <ShowcaseWrapper disableScrollTriggers={isMobile} />
                </div>
              </div>
            </div>
